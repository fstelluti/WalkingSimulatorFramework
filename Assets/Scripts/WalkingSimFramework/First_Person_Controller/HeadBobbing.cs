...
{
    /// <summary>
    /// Manages camera bobbing while moving
    ...
    public class HeadBobbing
    {
        ...
        public HeadBobbing(HeadBobbingData _data, float _moveBackwardsMultiplier, float _moveSideMultiplier)
        {
            m_data = _data;
